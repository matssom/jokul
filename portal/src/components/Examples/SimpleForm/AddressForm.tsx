    ...
    return (
        ...
        >
            ...
            <InfoMessage
                ...
                fullWidth
                className={`jkl-spacing-${isCompact ? "xs" : "s"}--top jkl-spacing-3xs--bottom`}
            >
            ...
            <div className="jkl-simple-form__postal-group">
                <TextInput
                    variant="large"
                    label="Postnummer"
                    className={isCompact ? "jkl-spacing-3xs--bottom" : "jkl-spacing-2xs--bottom"}
                    ...
                    {postnummer?.toString().length === 4 && (
                        <motion.p
                            ...
                            className={`jkl-simple-form__postal-group__area ${
                                isCompact ? "jkl-spacing-3xs--bottom" : "jkl-spacing-2xs--bottom"
                            }`}
                        >
                            Geilo
                        </motion.p>
