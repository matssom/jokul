...
Variablene kan importeres fra `~@fremtind/jkl-core/jkl` med @use syntaksen. Husk å bruke riktig importsyntaks for byggverktøyet ditt når du importerer. De kan da brukes slik:
