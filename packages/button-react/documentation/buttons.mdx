...
<ComponentExample
    component={Primary}
    knobs={{ boolProps: ["Kompakt", "Invertert", { prop: "withLoader", defaultValue: true }, "isLoading"] }}
>
...
<a href="#" className="jkl-button jkl-button--primary jkl-layout-spacing--medium-right">
    Send inn
</a>
<a href="#" className="jkl-button jkl-button--secondary jkl-layout-spacing--medium-right">
    Lagre
</a>
<a href="#" className="jkl-button jkl-button--tertiary jkl-layout-spacing--medium-right">
    Avbryt
</a>
