...
const BrowserPreferencesExample: VFC = () => {
    ...
    return (
        <section className="hooks-example key-listener-example jkl-spacing-xs--bottom">
            <h2 className="jkl-h2 jkl-spacing-2xs--bottom">Preferanser fra nettleseren din</h2>
            <dl>
