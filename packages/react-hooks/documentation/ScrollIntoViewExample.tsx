    ...
    return (
        <section style={{ height: "100vh", position: "relative" }}>
            <div style={{ display: "flex", flexDirection: "column" }}>
                <div>
                    <button
                        className="jkl-button jkl-button--primary jkl-spacing-2xs--bottom"
                        onClick={() => toggleAutoScroll(!autoScroll)}
                    >
                        {autoScroll ? "Skru av" : "Skru på"}
                    </button>
                    <button className="jkl-button jkl-button--secondary jkl-spacing-3xs--left" onClick={manualScroll}>
                        Scroll
                    </button>
                </div>
